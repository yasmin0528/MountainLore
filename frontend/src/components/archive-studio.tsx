...
export function ArchiveFolioDialog({ project, cards, busy, onClose, onSave, onDeleteRequest }: { project: Project; cards: ArchiveCard[]; busy: boolean; onClose: () => void; onSave: (card: ArchiveCard) => Promise<boolean>; onDeleteRequest: (card: ArchiveCard) => void }) {
