...
export function ArchiveFolioDialog({ project, cards, busy, onClose, onSave }: { project: Project; cards: ArchiveCard[]; busy: boolean; onClose: () => void; onSave: (card: ArchiveCard) => Promise<boolean> }) {
